    ...
    <div className="container m-auto text-black">
      ...
      <form className='px-4 md:px-48'>
        ...
        <div className="grid gap-6 mb-6 md:grid-cols-2 ">
          <div>
            <label forhtml="name" className="block mb-2 text-sm  text-gray-900 ">Name</label>
          ...
          <div>
            <label forhtml="phone" className="block mb-2 text-sm  text-gray-900 ">Phone</label>
          ...
          <div>
            <label forhtml="pincode" className="block mb-2 text-sm  text-gray-900 ">Pincode</label>
            <input type="number" id="state" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Pincode" required />
          </div>
        </div>
                ...
                <li key={k} className="hover:text-black">
                  <div className="item flex my-5">
                    <div className=" font-semibold text-sm">
                      {cart[k].name}({cart[k].size[0]}/{cart[k].variant[0]})
                    </div>
                    <div className="w-1/3 flex font-semibold text-center justify-center items-center text-lg">
                      <AiFillMinusSquare
                        onClick={() => {
                          removeFromCart(k, 1, cart[k].price, cart[k].name, cart[k].size, cart[k].qty);
                        }}
